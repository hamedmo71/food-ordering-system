...
public class OrderApplicationServiceTest {
    ...
    void testCreateOrderWithWrongTotalPrice() {
        ...
        assertEquals("Order price 250.00 is not equals to order items total: 200.00!", orderDomainException.getMessage());
    }
    ...
    public void testCreateOrderWithWrongProductPrice() {
        ...
        assertEquals("Order item price 60.00 is not valid for productId " + PRODUCT_ID, orderDomainException.getMessage());
    }
    ...
    public void testCreateOrderWithPassiveRestaurant() {
        ...
        assertEquals("Restaurant with id " + RESTAURANT_ID + " currently is not active.", orderDomainException.getMessage());
    }
